  ...
  return (
    <section className='!py-0 overflow-x-hidden'>
      <div className='bg-gradient-to-b from-skyblue via-lightskyblue dark:via-[#4298b0] to-white/10 dark:to-black/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-4 sm:px-5 2xl:px-0 pt-20 lg:pt-24 pb-0 md:pb-68'>
          <div className='relative text-white dark:text-dark text-center md:text-start z-10'>
            <p className='text-inherit text-sm sm:text-xm font-medium'>Phuket & Pattaya, Thailand</p>
            <h1 className='text-inherit text-4xl sm:text-6xl lg:text-8xl xl:text-9xl font-semibold -tracking-wider md:max-w-45p mt-4 mb-6'>
        ...
        <div className='md:absolute bottom-0 md:-right-68 xl:right-0 bg-white dark:bg-black py-8 sm:py-12 px-4 sm:px-8 mobile:px-16 md:pl-16 md:pr-[295px] rounded-none sm:rounded-2xl md:rounded-none md:rounded-tl-2xl mt-16 sm:mt-24'>
          <div className='grid grid-cols-2 sm:grid-cols-4 md:flex gap-4 xs:gap-6 sm:gap-12 md:gap-16 lg:gap-24 text-left sm:text-center dark:text-white text-black'>
